...
import cn.com.helei.bot.core.dto.system.CpuInfo;
import cn.com.helei.bot.core.dto.system.GpuInfo;
import cn.com.helei.bot.core.dto.system.MemoryInfo;
import lombok.Data;
...
public class SystemInfo {
    ...
    public static SystemInfo loadFromYaml(String classpath) {
        ...
        return  YamlConfigLoadUtil.load(SystemConfig.CONFIG_DIR_BOT_PATH, classpath, List.of("bot", "system"), SystemInfo.class);
    }
